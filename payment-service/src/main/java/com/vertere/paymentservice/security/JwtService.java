package com.vertere.paymentservice.security;  //which folder/namespace this class belongs to
 ...
 * issued elsewhere (e.g. by user-service) since payment-service doesn't
 * handle login itself.
 *
