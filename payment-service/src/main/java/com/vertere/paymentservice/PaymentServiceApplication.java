package com.vertere.paymentservice;  //which folder/namespace this class belongs to
...
/**
 * This is the entry point that starts up the whole payment-service app.
 *
 * - main: boots the Spring application, which wires up all the
 *   components (like Payment, Refund, and PaymentController) and starts
...
public class PaymentServiceApplication {
	...
	public static void main(String[] args) {   //the very first method that runs when the app starts
		SpringApplication.run(PaymentServiceApplication.class, args);   //hands control over to Spring to boot everything up
	}
